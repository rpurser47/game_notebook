...
## Sorrell
**Role:** Unknown (set up fishing hab)
**Location:** Level 5, fishing hab (probable: small shed near Theta)
**Status:** Unknown
**Related:** [[Roger]], [[Loadmaster's Key]], [[Facility Theta]]

- Set up the **fishing hab** ("fishing camp") on Level 5.
...
**Location:** Unknown
**Status:** Unknown
**Related:** [[Sorrell]], [[Jack]], [[Loadmaster's Key]], [[Facility Epsilon]]

- Lost the **Loadmaster's key** to Epsilon's secure storage.
- Mentioned the loss to **Jack**.
- Believed the key was left at Sorrell's fishing hab.

- Full name: Roger Patton (confirmed when security card key recovered).

## Jack
**Role:** Unknown
**Location:** Unknown
**Status:** Unknown
**Related:** [[Roger]], [[Loadmaster's Key]]

- Roger told him about losing the key.
- Tied to the fishing hab / lost key situation.
